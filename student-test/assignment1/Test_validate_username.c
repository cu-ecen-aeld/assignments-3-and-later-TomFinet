...
void test_validate_my_username()
{
    ...
    const char* username = (const char*) malloc_username_from_conf_file();
    TEST_ASSERT_EQUAL_STRING_MESSAGE(hardcoded_username, username, "github username is not configured correctly.");
    free((void *)username);
}
